...
@Component({
  selector: 'app-leccion-plist-usuario',
  templateUrl: './leccion-plist-usuario.component.html',
  styleUrls: ['./leccion-plist-usuario.component.css']
})
export class LeccionPlistUsuarioComponent implements OnInit {

  _id: number = 0;
  get _id_curso(): number {
    return this._id;
  }

  @Input() set id(value: number) {
    this._id = value;
    this.setFilterByCurso(value);
  }
